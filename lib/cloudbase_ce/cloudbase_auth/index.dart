...
class CloudBaseAuth extends AuthProvider {
  ...
  Future<bool> sendPhoneCode( String phoneNumber ) async {
    ...
    return await _phoneCodeAuthProvider!.sendPhoneCode( phoneNumber: phoneNumber );
  ...
  Future<CloudBaseAuthState> signInWithPhoneCode( {
    ...
    CloudBaseAuthState authState = await _phoneCodeAuthProvider!.signInWithPhoneCode(
  ...
  Future<CloudBaseAuthState> signUpWithPhoneCode( {
    ...
    CloudBaseAuthState authState = await _phoneCodeAuthProvider!.signUpWithPhoneCode(
      phoneNumber: phoneNumber,
      phoneCode: phoneCode,
      password: password,
